// import mercadoe from '@/http/instances/mercadoe'

// export async function getOrder(id) {
//   return mercadoe.get(`/orders/${id}`)
// }

/**
 * PS: tive alguns problema com CORS na API
 * então criei um mock com a promise para simular a requisição
 * e deixei feito a estrutura que eu faria para me comunicar com a API (linhas 1, 74 e a pasta http).
 */
